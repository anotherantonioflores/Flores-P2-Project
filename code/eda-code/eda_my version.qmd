...
#Comparing how age daa compares from those who subscribed to a term deposit and those
#that did not
ggplot(data=mydata)+
...
ggplot(pctjob, aes(x=reorder(job, numofYES), y=numofYES, fill=numofYES))+
  geom_bar(stat="identity")+
  coord_flip()
  
ggplot(pctjob, aes(x=reorder(job, (numofYES/numofBOTH)), y=(numofYES/numofBOTH)))+
  geom_bar(stat="identity")+
  coord_flip()
